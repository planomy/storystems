const stemCategories = {
  action: {
    ...
    surroundings: [
      ...
      "Balancing on the narrow ledge,",
      "Crouching beside the footprints,",
      "Holding the key to the light,",
      "Stepping over the broken tiles,",
      "Lowering himself through the hatch,",
      "Shielding her face from the rain,",
      "Tightening the strap on his bag,",
      "Folding the letter twice,",
      "Pushing the branches aside,",
      "Following the muddy track,",
      "Laying one hand on the wall,",
      "Checking the lock twice,",
  ...
  description: {
    character: [
      ...
      "A cold stare",
      "Marked by a distinct",
      "Instead of charm,",
      "With shoulders squared,",
      "A jagged scar crossed",
      "Beneath heavy brows,",
      "His weathered face held",
      "Her sharp cheekbones caught",
      "With sleeves rolled high,",
      "A silver streak cut",
      "His crooked smile revealed",
    ...
    setting: [
      ...
      "Thin Winter light",
      "Stale air",
      "Blade-like moonlight",
      "Above the rooftops,",
      "Echoes reverberated",
      "The smell of",
      "Thick layered shadows,",
      "Gleaming in the moonlight,",
      "Trailing smoke drifted",
      "The sound of",
      "Along the riverbank",
      "Near the altar,",
      "Against the colourful horizon,",
      "Past the iron gate,",
      ...
      "A black shroud crept",
      "Distinctly lacking any",
  ...
  feeling: {
    ...
    negative: [
      ...
      "A forgotten grave in her heart opened",
      "Beneath his ribs,",
      "Abandoned by rational thought,",
      "A hard knot formed,",
      "Daggers of guilt stabbed",
      "The thought scraped at,",
      ...
      "Fearful of another",
      "Feeling abnormally depressed,",
      "Deeply shaken by the incident,",
      "Weeping hysterically,",
      "Confused and disoriented",
      "Scolded by the memory of",
      "As if ashamed,",
      "The sudden darkening of his mood"
    ]
  },
  atmosphere: {
    inside: [
  ...
  story: {
    ...
    situation: [
      ...
      "Other than",
      "In a break from normality,",
      "A distinct possibility loomed:",
      "One word requiring no translation:",
      "Oddly enough,",
